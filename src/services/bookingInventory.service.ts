...
export const bookingDate = (value: string): Date => {
  ...
  // Availability is keyed by a calendar day, not server-local midnight. Keep
  // the stored timestamp at UTC midnight so an IST or other server timezone
  // cannot move a booking to the previous calendar date.
