...
export interface IAttractionTranslation { tenantId: Types.ObjectId; attractionId: Types.ObjectId; locale: 'de' | 'ru'; slug: string; status: 'draft' | 'published'; sourceUpdatedAt: Date; sourceSnapshot?: Record<string, unknown>; content: Record<string, unknown>; createdAt: Date; updatedAt: Date }
