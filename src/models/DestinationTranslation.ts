...
interface IDestinationTranslation { tenantId: Types.ObjectId; destinationId: Types.ObjectId; locale: 'de' | 'ru'; slug: string; status: 'draft' | 'published'; sourceUpdatedAt: Date; content: Record<string, unknown>; createdAt: Date; updatedAt: Date }
