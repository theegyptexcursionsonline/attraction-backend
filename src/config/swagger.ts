          ...
          properties: {
            ...
            pricingOptions: {
              ...
              items: {
                ...
                properties: {
                  id: { type: 'string', example: 'single-buggy' },
                  name: { type: 'string', example: 'Single or double buggy' },
                  description: { type: 'string' },
                  price: {
                    type: 'number',
                    minimum: 0,
                    description: 'Authoritative adult unit price or whole-package price, depending on pricingModel.',
                    example: 50,
                  },
                  pricingModel: {
                    type: 'string',
                    ...
                    default: 'per-person',
                    description: 'Legacy options without this field are priced per person.',
                  },
                  minParticipants: { type: 'integer', minimum: 1, maximum: 50, example: 1 },
                  maxParticipants: { type: 'integer', minimum: 1, maximum: 50, example: 2 },
                  childPrice: { type: 'number', minimum: 0 },
                  infantPrice: { type: 'number', minimum: 0 },
                  residentPrice: { type: 'number', minimum: 0 },
                },
              },
            },
            addons: {
              ...
              items: {
                ...
                properties: {
                  ...
                  name: { type: 'string', example: 'El Gouna hotel transfer' },
                  description: { type: 'string' },
                  price: { type: 'number', minimum: 0, example: 10 },
                  pricingModel: {
                    type: 'string',
                    enum: ['per-person', 'per-booking'],
                    default: 'per-booking',
                    description: 'Legacy add-ons without this field are priced once per booking.',
                  },
                },
              },
            },
            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  pricingBreakdown: {
                    type: 'object',
                    description: 'Immutable server-calculated pricing snapshot used for receipts and later reconciliation.',
                    properties: {
                      adultUnitPrice: { type: 'number', minimum: 0 },
                      childUnitPrice: { type: 'number', minimum: 0 },
                      infantUnitPrice: { type: 'number', minimum: 0 },
                      discountPercentage: { type: 'number', minimum: 0, maximum: 99.99 },
                      pricingModel: { type: 'string', enum: ['per-person', 'per-booking'] },
                      packagePrice: { type: 'number', minimum: 0 },
                      participantCount: { type: 'integer', minimum: 1, maximum: 50 },
                      minParticipants: { type: 'integer', minimum: 1, maximum: 50 },
                      maxParticipants: { type: 'integer', minimum: 1, maximum: 50 },
                    },
                  },
                  addons: {
                    type: 'array',
            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  addons: {
                    type: 'array',
                    description: 'Only catalog add-on IDs are accepted; names, prices, quantities, and totals are resolved by the server.',
                    items: {
                      type: 'object',
                      required: ['id'],
                      properties: {
